...
```mermaid
flowchart LR
A[Thews Thorguld<br>Captain] --> B["Deputy<br>Platoon x 4"] --> C["Dux<br>Watch x 5"] --> D["Watchman x 5"]
```
...
<figure> <img src="Collima Gate Two Man Watch.webp" width="600" class="center"> <figcaption>The watch team at Collima gate.</figcaption> </figure>
