...
images:
  - mask-risen.webp
yrt:
  natureNote: elven, Verdant
  rework: Hollow (Ironsworn)
  caption: A mask risen shambles forward — leaves, soil, and small bones accreted by Verdant flow around an elven recognition-mask, walked by an elder handler from a distance.
---
