...
images:
  - coldhusk.webp
yrt:
  natureNote: mana-saturated corpse
  rework: Frostbound (Ironsworn)
  caption: A coldhusk stands motionless in the permafrost where it died, waiting to draw heat from anything warmer that wanders within its grip-radius.
---
...
<figure> <img src="images/coldhusk.webp" width="400" class="center"> <figcaption>A coldhusk stands motionless in the permafrost where it died, waiting to draw heat from anything warmer that wanders within its grip-radius.</figcaption> </figure>
