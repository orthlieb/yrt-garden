...
source: yrt
images:
  - necrotic-sea-hare.webp
icon: foe-necrotic-sea-hare
yrt:
  escalates: true
  escalatingHarm:
    startHarm: 1
    ...
    rankCaps:
      ...
      '4': 5
      '5': 5
    removal: Sustained heat, concentrated Luminous mana, or saturated salt solution. Killing while attached without treating the wound does not reset — contaminated mucus remains active.
  natureNote: Azure+Black-saturated
  caption: A Necrotic Sea Hare — palm-sized, iridescent, and patient, trailing Black-saturated mucus across contaminated sediment.
---
