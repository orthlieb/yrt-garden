...
id: yrt/whispering-stones
name: The Whispering Stones
rank: 3
nature: Anomaly
source: yrt
images:
  - the-whispering-stones.webp
yrt:
  natureNote: pre-Fall site
  rework: Circle of Stones (Delve)
  caption: The Whispering Stones — a broken pre-Fall communication relay whose Amber lattice still leaks fragmentary memory into anyone who lingers inside the perimeter.
---
...
<figure> <img src="images/the-whispering-stones.webp" width="400" class="center"> <figcaption>The Whispering Stones — a broken pre-Fall communication relay whose Amber lattice still leaks fragmentary memory into anyone who lingers inside the perimeter.</figcaption> </figure>
