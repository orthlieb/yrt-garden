...
**Region:** Verday Groves · **Location:** Grove
**Location detail:** Between the eastern flank of the Pinna and the shore of Falter Sound
...
Above the halls run the **skywalks**. Branch is led to branch and held in contact until the two grow together and become one branch: the trick is ordinary and any orchard-keeper knows it happens, but nobody outside the Groves has ever done it at this scale or with this patience. A walk takes a generation. It is then stronger than any bridge Freeport has ever built and grows stronger every year afterward, which is the reverse of how the rest of the world's structures behave and is the thing that unsettles visitors most. The upper town is three levels of them in places, with rope-and-slat spans thrown across the young gaps as scaffolding for what the trees are being asked to do next. A Verdani will step onto a hundred-year-old span without looking at it and hesitate at a rope walk, because one of them is alive and known and the other is merely engineering.
